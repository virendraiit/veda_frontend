...
export default function StudentGameGeneratorPage() {
  ...
  const gameTypes = [
    ...
    { value: "board", label: "Board Game / बोर्ड खेळ" },
    { value: "puzzle", label: "Puzzle Game / कोडे खेळ" },
    { value: "educational", label: "Educational Game / शैक्षणिक खेळ" },
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Input
                      placeholder="e.g., Math Quiz Adventure, Science Puzzle Challenge"
                      value={title}
